...
/**
 * shadcn Button에 03 톤을 입힌 것(03 §6.1 "스타일 오버라이드만").
 *
 * 프로토타입의 .btn을 기준으로 삼는다: 타자기체 11.5px, 각진 테두리(radius 0 토큰),
 * 기본은 카드 표면 + 보조 텍스트색, primary는 사이트 액센트로 채운다.
 * 필 버튼·그라디언트는 금지 문법이다(03 §1.1).
 */
